...
<WebServiceRequestEntity>
   <description>Get all developers endpoint</description>
   <name>Get_All_Developers</name>
   <tag></tag>
   <elementGuidId>get-all-developers-endpoint</elementGuidId>
   ...
   <restUrl>${base_url}/api/developer-properties/developers</restUrl>
...
assertThat(responseBody.data.developers).isNotNull()
