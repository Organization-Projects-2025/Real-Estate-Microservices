...
<WebServiceRequestEntity>
   <description>Delete project endpoint</description>
   <name>Delete_Project</name>
   <tag></tag>
   <elementGuidId>delete-project-endpoint</elementGuidId>
   ...
   <variables>
      ...
      <description>Project ID to delete</description>
      <id>project_id</id>
      <masked>false</masked>
...
assertThat(responseBody.message).isEqualTo('Project deleted successfully')
</verificationScript>
